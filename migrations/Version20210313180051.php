 ...
 */
final class Version20210313180051 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE admin ALTER telephone DROP NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, image VARCHAR(255) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL)');
        $this->addSql('DROP TABLE users');
        $this->addSql('DROP INDEX "primary"');
        $this->addSql('ALTER TABLE admin ALTER telephone SET NOT NULL');
